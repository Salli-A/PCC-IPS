...
const char* com10 = "http://192.168.48.116/dist";
...
String getDist() {
  ...
  Serial.print("DIST Anchor4: ");
  Serial.println(distance4);

  // Create a String to send to Website on request
  String distance_string = String(distance1) + "," + distance2 + "," + distance3 + "," + distance4;
...
void loop() {
  ...
  distance4 = httpGETRequest(Anchor4);
