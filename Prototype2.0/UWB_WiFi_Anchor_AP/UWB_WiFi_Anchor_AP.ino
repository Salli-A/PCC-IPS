...
String getDist() {
  ...
  dist1 = median(distArray1);
  dist2 = median(distArray2);
  dist3 = median(distArray3);
  ...
  String distance_string = String(dist1) + "," + String(dist2) + "," + String(dist3);
...
double median(double dist_array[])
{

  int size = MedianArraySize;

  double temp_array[MedianArraySize];
  for (int i = 0; i < size; i++) {
    temp_array[i] = dist_array[i];
  }
